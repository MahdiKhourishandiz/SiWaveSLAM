...
class Config:
    def __init__(self):
        ...
        self.model_path: str = "/"
        self.first_frame_ref: bool = False
        self.begin_frame: int = 0
        self.end_frame: int = 100000
        ...
        self.stop_frame_thre: int = 20

        self.deskew: bool = False
        self.lidar_type_guess: str = "velodyne"
        self.min_range: float = 2.5
        self.max_range: float = 60.0
        self.adaptive_range_on: bool = False
    ...
    def load(self, config_file):
        ...
        if "setting" in config_args:
            self.name = config_args["setting"].get("name", "Siamese-Wavelet-SLAM")
